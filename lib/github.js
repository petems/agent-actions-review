...
function createCurlFetch() {
  return async (url, options = {}) => {
    const tempDir = mkdtempSync(path.join(os.tmpdir(), "agent-actions-review-"));
